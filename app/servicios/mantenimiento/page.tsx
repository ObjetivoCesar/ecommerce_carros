    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-black text-white py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/Taller_motos1.jpg"
            alt="Taller de motos especializado"
            fill
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-10 text-gray-100 font-medium leading-relaxed max-w-2xl">
                Mantenimiento profesional para tu motocicleta con técnicos certificados y repuestos originales en Loja, Ecuador.
              </p>
